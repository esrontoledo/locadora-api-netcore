using Es.Locadora.CrossCutting.IoC;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Es.Locadora.Api",
                    Description = "API - Locadora",
                    Version = "v1"
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UsePathBase("/locadora-api-netcore");
            app.UseSwagger();
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/locadora-api-netcore/swagger/v1/swagger.json", "Locadora.Api");
            });
